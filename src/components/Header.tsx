            ...
            <Box display="flex" justifyContent="end" mr={4}>
              ...
              <Tooltip label="Change refetch interval">
                <Button
                  ...
                  onClick={() => setRefetchInterval(refetchInterval === 3000 ? 1000 : 3000)}
                  leftIcon={<TimeIcon />}
                  variant="ghost"
                  color="white"
                  ml={4}
        ...
        <DrawerContent fontFamily="'Jersey 25'">
          ...
          <DrawerBody>
            <VStack spacing={4}>
              ...
              <Link to="/fee" className="[&.active]:font-bold" width="100%" onClick={onClose}>
                <Button width="100%" colorScheme="blue" variant="ghost" size="md">
                  GasFee
                </Button>
              </Link>
              <Link to="/blocks" className="[&.active]:font-bold" width="100%" onClick={onClose}>
                <Button mb={4} width="100%" colorScheme="blue" variant="ghost" size="md">
                  BlockSearch
                </Button>
              </Link>
              <Tooltip label="Change refetch interval">
          ...
          <DrawerFooter>
            <Button variant="outline" mr={3} onClick={onClose} fontFamily="'Jersey 25', sans-serif">
              Close
            </Button>
          </DrawerFooter>
        </DrawerContent>
